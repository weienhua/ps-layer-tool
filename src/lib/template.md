...
```
<Image src="{path[0]}{name[0]}.png" x="{x[0]}" y="{y[0]}" srcid="(#month+1)/10"	/>
<Image src="{path[1]}{name[1]}.png" x="{x[1]}" y="{y[1]}" srcid="(#month+1)%10"	/>
<Image src="{path[2]}{name[2]}.png"	x="{x[2]}" y="{y[2]}" />
<Image src="{path[3]}{name[3]}.png" x="{x[3]}" y="{y[3]}" srcid="#date/10" />
<Image src="{path[4]}{name[4]}.png" x="{x[4]}" y="{y[4]}" srcid="#date%10" />
<Image src="{path[5]}{name[5]}.png" x="{x[5]}" y="{y[5]}" srcid="#day_of_week" />
```
name:`6位日期srcExp写法（03/21星期六）`
```
<Image srcExp="'{path[0]}{name[0]}'+int(#cur_rq1)+'.png'"       x="{x[0]}" y="{y[0]}" />
<Image srcExp="'{path[1]}{name[1]}'+int(#cur_rq2)+'.png'"       x="{x[1]}" y="{y[1]}" />
<Image srcExp="'{path[2]}{name[2]}.png'"				        x="{x[2]}" y="{y[2]}" />
<Image srcExp="'{path[3]}{name[3]}'+int(#cur_rq3)+'.png'"       x="{x[3]}" y="{y[3]}" />
<Image srcExp="'{path[4]}{name[4]}'+int(#cur_rq4)+'.png'"       x="{x[4]}" y="{y[4]}" />
<Image srcExp="'{path[5]}{name[5]}'+int(#day_of_week)+'.png'" 	x="{x[5]}" y="{y[5]}" />
```